...

{
  programs.vscode = {
    ...
    profiles.default.extensions = with pkgs.vscode-extensions; [
      # 13xforever.language-x86-64-assembly # Assembly # ERROR
      alefragnani.bookmarks # Bookmarks
      antfu.icons-carbon # Icons
      ban.spellright # Spellcheck
      # beardedbear.beardedicons # Icons # NO PACKAGE
      # beardedbear.beardedtheme # A lot of nice looking themes # NO PACKAGE
      ...
      # codeque.codeque # Structured search # NO PACKAGE
      # danielpinto8zz6.c-cpp-project-generator # C++ projects # NO PACKAGE
      davidanson.vscode-markdownlint # Linter for markdown
      donjayamanne.githistory # Better git history
      eamodio.gitlens # Better git
      # edwinkofler.vscode-assorted-languages # Highlighting for somewhat obscure file types # NO PACKAGE
      # fabiospampinato.vscode-highlight # Highlight text based on regexes # NO PACKAGE
      # fisheva.eva-theme # Theme close to OneDark/OneLight # NO PACKAGE
      # franneck94.c-cpp-runner # Easier C++ compilation and execution # NO PACKAGE
      # franneck94.vscode-c-cpp-config # C++ projects # NO PACKAGE
      gruntfuggly.todo-tree # Write the number of TODOs and such in the status line
      james-yu.latex-workshop # Good LaTeX
      # jbenden.c-cpp-flylint # Linter for C++ # NO PACKAGE
      # jeff-hykin.better-cpp-syntax # Highlighter for C++ # NO PACKAGE
      # jeff-hykin.xd-theme # Theme close to OneDark/OneLight # NO PACKAGE
      jnoortheen.nix-ide # Highlighter and linter for Nix
      # kylinideteam.cppdebug # C++ debug using gdb # NO PACKAGE
      ...
      # michami4uulipiski.mi4uokai # Theme close to Monokai # NO PACKAGE
      ...
      # qcz.text-power-tools # Text editing powertool # NO PACKAGE
      # solomonkinard.git-blame # Note git blame # NO PACKAGE
      # srcery-colors.srcery-colors # Theme # NO PACKAGE
      ...
      # wildberries-theme.wildberries # Purple theme # NO PACKAGE
